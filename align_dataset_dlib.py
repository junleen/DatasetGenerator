...
def main(args):
    ...
    dlibpp_detector = dlibpp.DLIBPP(num_of_marks=args.num_marks, plus=args.plus)
            ...
            for image_path in cls.image_paths:
                ...
                if not os.path.exists(output_filename):
                    try:
                        ...
                        bounding_boxes, points = dlibpp_detector.detect_faces(img)
...
def cropImage(image, center, size, resolution_size=256):
    '''
    ...
    #image = image/255.
    cropped_image = warp(image, tform.inverse, output_shape=(resolution_size, resolution_size))
